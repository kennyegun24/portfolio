        ...
        <div className='Header flex justifyCenter flexColumn'>
            <div data-aos="fade-right">
                ...
                <div className='icons flex'>
                    <a href='https://github.com/kennyegun24' target="_blank" rel="noopener noreferrer"><FaGithub /></a>
                    <a href='https://linkedin.com/in/kenny-egun-kennyegun24' target="_blank" rel="noopener noreferrer"><FaLinkedin /></a>
                </div>
            </div>
        </div>
    )
